    ...
    <div class="row">
        ...
        <div class="col-md-2 bg-white min-vh-100 shadow-sm border-end py-4 px-0">
            <div class="list-group list-group-flush rounded-0">
                ...
                <a href="transactions.php" class="list-group-item list-group-item-action active fw-semibold border-0 py-3 px-4">
        ...
        <div class="col-md-10 py-4 px-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold text-dark"><i class="fa-solid fa-list text-primary me-2"></i> All Transactions</h2>
            </div>
                ...
                <div class="card-body">
                    <form method="GET" action="transactions.php" class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="searchBox" name="search" class="form-control" placeholder="Search..." value="<?= htmlspecialchars($search) ?>" autocomplete="off">
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <button type="submit" class="btn btn-primary w-100 fw-semibold"><i class="fa-solid fa-filter"></i> Filter</button>
                        </div>
                    </form>
                </div>
            </div>
                        ...
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                <?php if (empty($transactions)): ?>
                                    <tr>
                                        <td colspan="7" class="text-center py-5 text-muted">No transactions found matching your criteria.</td>
                                    </tr>
                                <?php else: ?>
                                    <?php foreach ($transactions as $t): ?>
                                        <tr>
                                            ...
                                            <td><span class="badge bg-secondary"><?= htmlspecialchars($t['category_name'] ?? 'N/A') ?></span></td>
                                            <td>
                                            ...
                                            <td><?= htmlspecialchars($t['payment_name'] ?? 'N/A') ?></td>
