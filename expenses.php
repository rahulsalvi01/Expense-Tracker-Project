    ...
    <div class="row">
        ...
        <div class="col-md-2 bg-white min-vh-100 shadow-sm border-end py-4 px-0">
            <div class="list-group list-group-flush rounded-0">
                ...
                <a href="expenses.php" class="list-group-item list-group-item-action active fw-semibold border-0 py-3 px-4">
        ...
        <div class="col-md-10 py-4 px-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold text-dark"><i class="fa-solid fa-arrow-trend-down text-danger me-2"></i> My Expenses</h2>
            </div>
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-white pt-3 pb-0 border-0 d-flex justify-content-between align-items-center">
                            <h5 class="fw-bold m-0"><?= $editMode ? 'Edit Expense' : 'Add New Expense' ?></h5>
                            <?php if ($editMode): ?>
                        ...
                        <div class="card-body">
                            <form method="POST" onsubmit="this.querySelector('button[type=submit]').disabled = true; this.querySelector('button[type=submit]').innerHTML = 'Saving...';">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" class="form-control" placeholder="e.g. Lunch" value="<?= htmlspecialchars($editData['title']) ?>" required>
                                </div>
                                ...
                                <button type="submit" class="btn <?= $editMode ? 'btn-primary' : 'btn-danger' ?> w-100 fw-semibold py-2">
                                ...
                                <table class="table table-hover align-middle">
                                    ...
                                    <tbody>
                                        <?php if (empty($expenses)): ?>
                                            <tr>
                                                <td colspan="6" class="text-center py-4 text-muted">No expenses found. Start adding some!</td>
                                            </tr>
                                        <?php else: ?>
